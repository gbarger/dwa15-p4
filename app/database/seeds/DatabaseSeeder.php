...
class SongTableSeeder extends Seeder
{
	public function run()
	{
		...
		$song->user_id = 1;
		$song->image_path = '';
		$song->file_path = './songs/Recital-English.m4a';
		$song->title = 'Recital - English';
		$song->artist = 'Danielle Barger';
		$song->year = 2014;
		$song->track = 1;
		$song->genre = 'Opera';
		$song->save();
		...
		$song2->user_id = 1;
		$song2->image_path = '';
		$song2->file_path = './songs/Recital-French.m4a';
		$song2->title = 'Recital - French';
		$song2->artist = 'Danielle Barger';
		$song2->year = 2014;
		$song2->track = 1;
		$song2->genre = 'Opera';
		$song2->save();
		...
		$song3->user_id = 1;
		$song3->image_path = '';
		$song3->file_path = './songs/Recital-German.m4a';
		$song3->title = 'Recital - German';
		$song3->artist = 'Danielle Barger';
		$song3->year = 2014;
		$song3->track = 1;
		$song3->genre = 'Opera';
		$song3->save();
		...
		$song3->user_id = 1;
		$song3->image_path = '';
		$song3->file_path = './songs/Recital-Italian.m4a';
